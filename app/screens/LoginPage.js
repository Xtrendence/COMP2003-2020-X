	...
	return (
		<View style={styles.pageContainer}>
			...
			<View style={styles.loginForm}>
				...
				<TextInput style={styles.inputField} selectionColor={globalColors.accentDark} underlineColorAndroid="transparent" placeholder="Password..."></TextInput>
				<TouchableOpacity style={styles.actionButton}>
					<Text style={styles.actionText}>Login</Text>
				</TouchableOpacity>
				<Text style={styles.switcherText}>Don't have an account?</Text>
			</View>
