...
<div class="landing-navbar">
    ...
    <a href="help.php"><button class="navbar-button">
    ...
    <a href="developers.php"><button class="navbar-button">
    ...
    <a href="https://github.com/Xtrendence/COMP2003-2020-X"><button class="navbar-button">
